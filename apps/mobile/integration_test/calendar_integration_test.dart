...
void main() {
  ...
  group('Calendar feature — integration (emulator required)', () {
    // ── Scenario 1 ─────────────────────────────────────────────────────────
    testWidgets('Calendar screen loads and shows TableCalendar widget', (
      tester,
    ) async {
    ...
    // ── Scenario 2 ─────────────────────────────────────────────────────────
    testWidgets('Tapping a calendar day updates the session-list panel', (
      tester,
    ) async {
      // TODO: run against emulator
      // Steps:
    ...
    // ── Scenario 3 ─────────────────────────────────────────────────────────
    testWidgets('Month/week toggle switches the calendar format', (
      tester,
    ) async {
      // TODO: run against emulator
      // Steps:
    ...
    // ── Scenario 4 ─────────────────────────────────────────────────────────
    testWidgets('Overflow pill navigates to CalendarDayScreen', (tester) async {
      // TODO: run against emulator
      // Steps:
      //   1. Sign in and navigate to /calendar.
