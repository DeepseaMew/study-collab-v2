  ...
  return ProviderScope(
    overrides: [
      authStateNotifierProvider.overrideWith(
        () => _StubNotifier(const AsyncValue.data(AuthState.unauthenticated())),
      ),
    ],
    child: MaterialApp(
  ...
  group('SignUpScreen golden', () {
    testWidgets('scale 1.0 — th locale', (tester) async {
      ...
      await expectLater(
        ...
        matchesGoldenFile('goldens/sign_up_screen_scale_1.0_th.png'),
      );
    });
    ...
    testWidgets('scale 1.5 — th locale', (tester) async {
      ...
      await expectLater(
        find.byType(SignUpScreen),
        matchesGoldenFile('goldens/sign_up_screen_scale_1.5_th.png'),
      );
    });
  });
}
